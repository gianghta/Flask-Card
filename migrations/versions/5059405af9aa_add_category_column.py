...
def upgrade():
    ...
    op.add_column('collection', sa.Column('category', sa.String(length=64), nullable=True))
    op.create_index(op.f('ix_collection_category'), 'collection', ['category'], unique=False)
